...
const Features = () => {
  ...
  useGSAP( () => {
    gsap.to('#exploreVideo', {
      ...
      scrollTrigger:{
          ...
          toggelActions: 'play pause reverse restart',
          start: '-10% bottom ',
  ...
  return (
    <section className="h- object-cover common-padding bg-zinc relative overflow-hidden">
      <div className="screen-max-width ">
        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
          ...
          <div className="flex-center flex-col sm:px-10">
            <div className="relative h-[50vh] w-ful flex items-center" preload="none" muted autoPlay ref={videoRef}>
